      ...
      <div class="col-12">
         <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title">Contact to Seller List</h4>
          </div>
                  ...
                  <?php if (!empty($data)):?>
                    <?php $i=1; 
                      ...
                      <tr>
                        ...
                        <td>
                        	<a href="<?php echo base_url('Admin/deletet_connect_seller_list/').$value->id ?>" class="btn btn-flat btn-danger rounded-circle" style="background-color:#CC0000; color:white; border-radius:5px; padding:5px 11px; font-size: 14px;" ><i class="fa fa-trash"></i></a></td>
                      </tr>
