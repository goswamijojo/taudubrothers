                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                  ...
                                  <?php if ($this->session->flashdata('nototp')) { ?>

                                    <div class="alert alert-danger">
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
                                      <strong><?php echo $this->session->flashdata('nototp'); ?></strong>
                                     </div>

                                     <?php } ?>
                                     <h5 style="color:green">CHECK EMAIL</h5>
                  <div class="text-center mb-3">
                    <!-- <img src="<?php echo base_url();?>home/theme-assets/images-3d-animation/logo.png" alt=""> -->
                  </div>
                                    <h4 class="text-center mb-4">OTP Varification</h4>
                                    <form action="<?=base_url()?>admin/match_otp" method="post">
                                        <div class="form-group">
                                            <label class="mb-1"><strong>Enter OTP</strong></label>
                                            <input type="text" name="otp"  placeholder="OTP" class="form-control" value="">
                                        </div>
                                        <div class="text-center">
                                            <input type="submit" name="submit" value="Varify" class="btn btn-primary btn-block">
                                        </div>
                                    </form>
