...
<img src="assets/images/shoes/shoes2.jpeg" alt="Product">
</div>
</div>
<div class="item owl-thumb-item">
<div class="top-img-left">
...
<h2>NORTH PLUS Running Shoes For Men  (Black)</h2>
<ul class="reviews">
<li>
...
<li>Color: <span>
Black</span></li>
<li>Model name: <span>NORTH PLUS</span></li>
<li>Ideal for: <span>
Men</span></li>
<li>Weight: <span>450 g (per single Shoe) - Weight of the product may vary depending on size.</span></li>
</ul>
<ul class="cart">
<li>
<ul class="number">
