		...
		<section class="content">
		  ...
		  <div class="row">
            ...
            <?php endif ?></center>
				...
				<form action="<?php echo base_url('Admin/edit_sub_subcategory/'.$data->id) ?>" enctype="multipart/form-data" method="post"> 
				<div class="box-body">
				  ...
				  <div class="form-group col-lg-6">
					...
					<div class="input-group">
					  <div class="input-group-prepend">
					   ...
					   <input type="text" class="form-control" name="sub_subcategory" value="<?php echo $data->sub_subcategory ?>" >
					</div>
					<!-- /.input group -->
				  </div>
          <div class="form-group col-lg-6">
                  ...
                  <?php if (!empty($sub_subcat)):?>
                    <?php $i=1; 
                      ...
                      <tr>
                        ...
                        <td>
                        	<a href="<?php echo base_url('Admin/sub_subcategory/').$value->id ?>" class="btn btn-flat btn-danger rounded-circle" style="background-color:#ef6c00; color:white; border-radius:5px; padding:5px 11px; font-size: 14px;" ><i class="fa fa-edit"></i></a>
