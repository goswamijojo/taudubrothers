    ...
    <div class="container">
        <div class="row">
                ...
                <div class="left-side-tabs">
                    <div class="dashboard-left-links">
                       ...
                       <?php if(!empty($user->kyc_status)) { ?>
                         <a href="<?php echo base_url('add_product');?>" class="user-item active"><i class="uil uil-wallet"></i>Add Product</a>
            ...
            <div class=" pt-5 pb-5">
                    <div class=" ">
                        <div class="user-item">
                            <form method="post" action="<?php echo base_url(); ?>add_seller_product" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Other Offer:" name="other_offer">
                                        </div>
                                    </div>
                                   ...
                                   <?php if($user->kyc_type==1) { ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="color product:" name="color" required="">
                                            <!-- <select class="form-control" id="exampleFormControlSelect1">
                                                <option>red</option>
                                                <option>green</option>
                                  ...
                                  <?php } ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <?php foreach($brand2 as $res){?>
                                       
                                        <option value="<?= $res->id ?>"><?= ucfirst($res->brand_name) ?></option>
                                        <?php } ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <option value="<?= $res->id ?>"><?= ucfirst($res->country_name) ?></option>
                                        <?php } ?>
