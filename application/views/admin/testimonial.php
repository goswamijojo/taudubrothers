  ...
  <div class="content-wrapper">
		...
		<section class="content">
		  ...
		  <div class="row">
            ...
            <?php endif ?></center>
				...
				<form action="<?php echo base_url('Admin/add_testimonial/') ?>" enctype="multipart/form-data" method="post"> 
				 <div class="box-body">
    ...
    <section class="content">
      ...
      <div class="col-12">
         <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title">Testimonials List</h4>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
                    ...
                    <?php $i=1; 
                      ...
                      <tr>
                        ...
                        ?>
                           ...
                           <td>
                          <a href="<?php echo base_url('Admin/edit_testimonial/').$value->id ?>" class="btn btn-flat btn-danger rounded-circle" style="background-color:#ef6c00; color:white; border-radius:5px; padding:5px 11px; font-size: 14px;" ><i class="fa fa-edit"></i></a>
                          
                          
                          
                          <a href="<?php echo base_url('Admin/delete_testimonial/').$value->id ?>" class="btn btn-flat btn-danger rounded-circle" style="background-color:#CC0000; color:white; border-radius:5px; padding:5px 11px; font-size: 14px;" ><i class="fa fa-trash"></i></a></td>
                      </tr>
                    <?php endforeach ?>
                  <?php endif ?>
                </tbody>
