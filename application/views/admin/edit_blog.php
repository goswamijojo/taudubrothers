		...
		<section class="content">
		  ...
		  <div class="row">
            ...
            <?php endif ?></center>
				...
				<form action="<?php echo base_url('Admin/edit_blog/'.$data->id) ?>" enctype="multipart/form-data" method="post"> 
				 <div class="box-body">
				...
				<div class="row">
				  <div class="form-group col-lg-12">
					...
					<div class="input-group">
					  ...
					  <input type="text" class="form-control" value="<?php echo $data->date ?>" name="date" >
					</div>
					<!-- /.input group -->
				  </div>
				...
				<div class="row">
				  <div class="form-group col-lg-12">
					...
					<div class="input-group">
					  ...
					  <textarea class="form-control" name="discription" value="" rows="2"><?php echo $data->discription; ?></textarea>
                     <script>
