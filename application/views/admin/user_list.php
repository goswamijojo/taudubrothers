                  ...
                  <?php if (!empty($data)):?>
                    <?php $i=1; 
                      ...
                      <tr>
                        ...
                        <!--<td><a class="btn btn-sm btn-primary" href="<?=base_url().'uploads/'.$value->image; ?>" title="View Image"><i class="fa fa-image"></i></a></td>-->
                         <td><a class="btn btn-sm btn-primary" href="<?php echo $value->image ?>" title="View Image"><i class="fa fa-image"></i></a></td>
                         <?php
                        
                         $kyc_check = $this->am->selectrow('seller_registeration',array('user_id'=>$value->id));
                         ?>
                        <td>
                            <?php 
                            if(!empty($kyc_check)){
                                ?>
                                <center><span class="btn btn-info btn-sm" data-toggle="modal" data-target="#packageModel9<?= $kyc_check->user_id?>" id="status"><i style="font-size: 15px;" class="fa fa-eye"></i></span></center>
                                <?php
                            }
                            else{
                        ...
                        <td>
                        	<a href="<?php echo base_url('Admin/delete_user/').$value->id ?>" class="btn btn-flat btn-danger rounded-circle" style="background-color:#CC0000; color:white; border-radius:5px; padding:5px 11px; font-size: 14px;" ><i class="fa fa-trash"></i></a></td>
                      </tr>
